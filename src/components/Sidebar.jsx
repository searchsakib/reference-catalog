const Sidebar = ({ toc, expanded, toggleSection, scrollTo }) => (
  <aside className="w-full border-b border-[#d8c8a3] bg-[#fffaf1] lg:sticky lg:top-0 lg:flex lg:h-screen lg:w-[320px] lg:min-w-[320px] lg:flex-col lg:border-b-0 lg:border-r lg:border-[#d8c8a3]">
    <div className="border-b border-[#d8c8a3] bg-[#fffaf1]/95 px-5 py-5 backdrop-blur">
